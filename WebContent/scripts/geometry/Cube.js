...
//Build the vertices
	...
	this.addVertex(-0.5, -0.5, -0.5, Geometry.colors.YELLOW); //Begin left side
	this.addVertex(-0.5,  0.5,  0.5, Geometry.colors.YELLOW);
	this.addVertex(-0.5,  0.5, -0.5, Geometry.colors.YELLOW);
	this.addVertex(-0.5, -0.5, -0.5, Geometry.colors.YELLOW);
	this.addVertex(-0.5, -0.5,  0.5, Geometry.colors.YELLOW);
	...
	this.addVertex(-0.5,  0.5,  0.5, Geometry.colors.CYAN); //Begin front side
	this.addVertex(-0.5, -0.5,  0.5, Geometry.colors.CYAN);
	this.addVertex( 0.5, -0.5,  0.5, Geometry.colors.CYAN);
	this.addVertex(-0.5,  0.5,  0.5, Geometry.colors.CYAN);
	this.addVertex( 0.5, -0.5,  0.5, Geometry.colors.CYAN);
	this.addVertex( 0.5,  0.5,  0.5, Geometry.colors.CYAN); //End front side
	
	this.addVertex( 0.5,  0.5,  0.5, Geometry.colors.GREEN); //Begin right side
	this.addVertex( 0.5, -0.5,  0.5, Geometry.colors.GREEN);
	this.addVertex( 0.5, -0.5, -0.5, Geometry.colors.GREEN);
	this.addVertex( 0.5,  0.5,  0.5, Geometry.colors.GREEN);
	this.addVertex( 0.5, -0.5, -0.5, Geometry.colors.GREEN);
	this.addVertex( 0.5,  0.5, -0.5, Geometry.colors.GREEN); //End right side
	
	this.addVertex(-0.5, -0.5, -0.5, Geometry.colors.WHITE); //Begin bottom side
	this.addVertex(-0.5, -0.5,  0.5, Geometry.colors.WHITE);
	this.addVertex( 0.5, -0.5,  0.5, Geometry.colors.WHITE);
	this.addVertex(-0.5, -0.5, -0.5, Geometry.colors.WHITE);
	this.addVertex( 0.5, -0.5,  0.5, Geometry.colors.WHITE);
	this.addVertex( 0.5, -0.5, -0.5, Geometry.colors.WHITE); //End bottom side
